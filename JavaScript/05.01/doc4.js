...
// container.addEventListener('click',(e)=>{
//   if(e.target.className !== `trigger` || dropDown.style.display == 'none'){
//     dropDown.style.display = 'block'
//     return console.log(1)
//     }
//     else{
...
/**
 * ! 트리거가 클릭 되면 dropDown의 dp값을 none로 할당해줘
 * ! 만일, dropdown의 dp값이 none이면 
 */
...
// container.addEventListener('click' , (e)=>{
//   if(e.target.className !== 'trigger' && dropDown.style.display !== 'block'){
//     dropDown.style.display = 'none'
//     console.log(1)
